...
def test_LO1A_writer():
    ...
    original_fits = open_original_fits("./tests/data/sample_LO1A.fits")
    ...
    write_file(original_fits, './tests/data/new_LO1A.fits', overwrite_bool=True)
    original_fits.close()

    new_fits = fits.open('./tests/data/new_LO1A.fits')
    ...
    new_fits.close()
    os.remove('./tests/data/new_LO1A.fits')

    # Make sure the original didn't get overwritten
    old_fits = fits.open('./tests/data/sample_LO1A.fits')
